...
# HIDL
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := hardware/qcom-caf/common/vendor_framework_compatibility_matrix.xml hardware/sony/vintf/device_framework_matrix.xml vendor/lineage/config/device_framework_matrix.xml
...
BOARD_SOMC_DYNAMIC_PARTITIONS_SIZE := 7243563008 # Dynamic partition size = (Super partition size / 2) - 4MB
BOARD_SUPER_PARTITION_GROUPS := somc_dynamic_partitions
BOARD_SUPER_PARTITION_SIZE := 14495514624
BOARD_SYSTEM_EXTIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_USERDATAIMAGE_PARTITION_SIZE := 235769556992 # Reserve space for data encryption (109553123000-16384)
...
# Use External DTC
TARGET_KERNEL_ADDITIONAL_FLAGS := DTC_EXT=$(shell pwd)/prebuilts/misc/linux-x86/dtc/dtc DTC_OVERLAY_TEST_EXT=$(shell pwd)/prebuilts/misc/$(HOST_OS)-x86/libufdt/ufdt_apply_overlay LLVM=1 LLVM_IAS=1
